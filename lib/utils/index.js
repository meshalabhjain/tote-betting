...
/**
* This function parses the bet input and returns error in case of invalid format 
* @param {betString} - input bet string
* @param {cb} - callback 
*/
exports.parseBet = function(betString, cb){
    var betArray = betString.split(':');
    if(!betArray[0] === "Bet" || betArray.length !==4){
      return cb("Format of the bet is not correct, Please try again");
    }
    return cb(null, {"product": betArray[1],
...
/**
* This function parses the result input and returns error in case of invalid format 
* @param {betString} - input result string
* @param {cb} - callback 
*/
exports.parseResult = function(resultString, cb){
    var resultArray = resultString.split(':');
    if(!resultArray[0] === "Result" || resultArray.length !==4){
      return cb("Format of the result is not correct, Please try again");
    }
    return cb(null, {"first": resultArray[1],
